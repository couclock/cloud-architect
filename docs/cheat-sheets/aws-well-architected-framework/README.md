# AWS Well Architected framework Micro Certification


## 📚 Table of Contents

- Section 1 – [Framework overview](section1-overview.md)
- Section 2 – [How to run a review](section2-review.md)
- Section 3 – [AWS Well-Architected tool](section3-watool.md)
